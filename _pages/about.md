...
- Yue, Z.<sup>†</sup>, **Tang, S.**<sup>†</sup>, Yan, P., Yang, M., Li, D.<sup>#</sup>, Friederici, A. D.<sup>#</sup>, & Chen, L.<sup>#</sup> (Under review). Theta oscillations underpin syntactic encoding in first and second language sentence production. ***NeuroImage***.
- Tao, F., Li, D.<sup>#</sup>, **Tang, S.**<sup>#</sup>, Ge, X., Ma, W., Esposito, A., & Vinciarelli, A. (Under review). Emotional arousal over valence: Cross-linguistic speech-based depression detection with neurophysiological validation. ***Journal of Affective Disorders***.
...
- Li, D., Qi, M., **Tang, S.**, Chen, L., & Cui, X. (2025). Neurodevelopmental basis of parafoveal attention encoding in children during natural Chinese reading. ***Advances in Psychological Science*** (in Chinese).
